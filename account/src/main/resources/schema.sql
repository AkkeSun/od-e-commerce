...
CREATE INDEX IF NOT EXISTS ACCOUNT_HISTORY_IDX_1 ON ACCOUNT_HISTORY (ACCOUNT_ID);
CREATE INDEX IF NOT EXISTS ACCOUNT_HISTORY_IDX_2 ON ACCOUNT_HISTORY (EMAIL);
CREATE INDEX IF NOT EXISTS ACCOUNT_HISTORY_IDX_3 ON ACCOUNT_HISTORY (EMAIL, HISTORY_TYPE);
