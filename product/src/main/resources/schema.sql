...
CREATE INDEX PRODUCT_HISTORY_IDX_2 ON PRODUCT_HISTORY (REG_DATE_TIME);
CREATE INDEX PRODUCT_HISTORY_IDX_3 ON PRODUCT_HISTORY (PRODUCT_ID, ACCOUNT_ID);
...
CREATE INDEX REVIEW_IDX_1 ON REVIEW (PRODUCT_ID);
CREATE INDEX REVIEW_IDX_2 ON REVIEW (PRODUCT_ID, ACCOUNT_ID);
